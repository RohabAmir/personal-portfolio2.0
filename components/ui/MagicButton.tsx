...
const MagicButton = ({
  ...
  return (
    ...
    >
      ...
      />
      <span 
        className={`inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg dark:bg-slate-950 bg-[#EDE2FB] px-7 text-sm font-medium dark:text-white text-slate-900 gap-2 ${position === 'left' ? 'flex-row-reverse' : ''}`}
        style={{
